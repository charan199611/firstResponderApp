...
@Component({
  selector: 'app-unit-summary-list',
  templateUrl: './unit-summary-list.page.html',
  styleUrls: ['./unit-summary-list.page.scss'],
})
export class UnitSummaryListPage implements OnInit {
  ...
  loadCFSDetails(cfsId, unreadStatus, basicId, fromUserType) {
    ...
    this.customNavService.navigateByUrl('unit-summary/unit-summary-details', data)
  ...
  fetchTodayCFSData() {
    this.eventService.getWeekUnitSummaryList(moment().subtract(0, 'days').startOf('day').format('YYYY-MM-DD HH:mm:ss'), moment().endOf('day').format('YYYY-MM-DD HH:mm:ss')).then((message: any[]) => {
  ...
  fetch7DaysCFSData() {
    ...
    this.eventService.getWeekUnitSummaryList(moment().subtract(7, 'days').startOf('day').format('YYYY-MM-DD HH:mm:ss'), moment().endOf('day').format('YYYY-MM-DD HH:mm:ss')).then((message: any[]) => {
      this.rowData = message;
      this.cfsList = [];
      this.showStatus(this.filterStatus);
  ...
  fetch30DaysCFSData() {
    this.eventService.getWeekUnitSummaryList(moment().subtract(30, 'days').startOf('day').format('YYYY-MM-DD HH:mm:ss').toString(), moment().endOf('day').format('YYYY-MM-DD HH:mm:ss').toString()).then((message: any[]) => {
      this.rowData = message;
      this.cfsList = [];
      this.showStatus(this.filterStatus);
